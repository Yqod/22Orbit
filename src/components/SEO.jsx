...
const SEO = ({ 
  ...
  const fullTitle = title 
    ? `${title} | 22Orbit - Webentwicklung` 
    : '22Orbit - Webentwicklung & Digitale Lösungen';
...
export const seoConfig = {
  ...
  software: {
    title: 'Individuelle Software-Lösungen',
    description: 'Maßgeschneiderte Software-Entwicklung für Ihre spezifischen Geschäftsanforderungen. Effizient, skalierbar und zukunftssicher.',
    keywords: 'Software-Entwicklung, Custom Software, Business Software, CRM, ERP, Automatisierung, API-Integration, Cloud-Lösungen'
  },
