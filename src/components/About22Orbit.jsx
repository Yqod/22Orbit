  ...
  <section id="About22Orbit" className="w-full bg-gradient-to-b from-[#0d1321] via-[#1d2d44] to-[#0d1321] py-20 px-4 my-0 flex items-center justify-center pt-28">
    <div className="max-w-6xl w-full mx-auto flex flex-col md:flex-row items-center justify-between gap-0 md:gap-20">
      ...
      <div className="block md:hidden w-full max-w-xl mx-auto text-center mb-12">
        <h2 className="font-bebas text-4xl text-[#f0f8ff] font-bold tracking-widest drop-shadow-lg mb-6">
          Wer wir sind ? 
        </h2>
       
        <p className="text-[#f0f8ff] text-lg font-light mb-6 leading-relaxed">
          <span className="font-bebas text-xl text-[#f0f8ff]">22Orbit</span> ist eine junge Webagentur im Herzen <span className="font-bebas text-xl text-[#f0f8ff]">Magdeburgs</span>,mit einer großen Liebe zur <span className="font-bebas text-xl text-[#f0f8ff]">Webentwicklung</span> und digitalen Innovation.
        </p>
         <img
